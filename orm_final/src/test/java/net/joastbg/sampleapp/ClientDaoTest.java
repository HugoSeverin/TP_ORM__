...
public class ClientDaoTest {
    ...
    public void setUp() {
        ...
        client.setPrenom("Gol");
        client.setNom("D Roger");
        ...
        contact.setValeur("0680622756");

        assurance = new Assurance();
        assurance.setDate_anniversaire(new Date(1996-01-01));
        assurance.setDate_prelevement(new Date(2002-01-17));
        assurance.setDate_souscription(new Date(2000-01-25) );
